...
const Mission = () => {
    ...
    return (
        <div>
            <h1 className='text-center pb-12 text-3xl md:text-5xl font-bold text-[#2C3333]'>Mission & Vision</h1>
            <div data-aos="fade-right" data-aos-duration="800" className='grid lg:grid-cols-2 items-center gap-6'>
                <div>
                    <h1 className='text-3xl font-black pb-4 text-[#02A95C]'>Our Mission</h1>
            ...
            <div data-aos="zoom-in" data-aos-duration="800" className='grid lg:grid-cols-2 items-center mt-12 gap-6'>
                ...
                <div>
                    <h1 className='text-3xl font-black pb-4 text-[#02A95C]'>Our Vision</h1>
